...
\begin{frame} \frametitle{\insertsection}
    ...
    \centering\includegraphics[width=0.8\textwidth]{images/several-b}
...
\begin{frame} \frametitle{\insertsection}
    ...
    \centering\includegraphics[width=0.89\textwidth]{images/constant-accuracy}

\end{frame}

%---------------------------------------------------
\section{Results: Single Host with Linear Population}
%---------------------------------------------------
